...
SECRET_KEY = 'django-insecure-6lz^0d(+vk-1w(htv_2l9y4%_%d^sp_c=oxe!qw(0(e2qn^6^c'
...
# we need this real email backend not dummy backend
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # it's neccesery for my context_processors
